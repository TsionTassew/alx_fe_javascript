...
// ===============================
// Display Random Quote (REQUIRED NAME)
// ===============================
...
// Add event listener for “Show New Quote” button (REQUIRED)
document.getElementById("newQuote").addEventListener("click", displayRandomQuote);

// ===============================
// Adding New Quotes (REQUIRED NAME)
// ===============================
function addQuote() {
  ...
  textInput.value = "";
  categoryInput.value = "";
  displayRandomQuote(); // update the DOM after adding
}
